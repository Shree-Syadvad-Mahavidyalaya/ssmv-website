...
function EditSptlght() {
    const navigate=useNavigate();
    const [subject, setSubject] = useState({ description: '', imagesurl: '' , name:'', profile:'' });
      ...
      const handleEdit = async (event) => {
        ...
        try {
          const response = await fetch(
            `https://test-moid.vercel.app/ssmv/alumni/spotlight/${subjectId}/`,
            {
              method: 'PUT',
              headers: {
